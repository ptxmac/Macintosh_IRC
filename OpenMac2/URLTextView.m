...
- (void)mouseDown:(NSEvent*)inEvent
{
	...
	[[self textStorage] addAttribute:NSForegroundColorAttributeName value:[NSColor redColor] range:linkRange];
	while( !done )
	{
		...
		switch( [inEvent type] )
		{
			...
			case NSLeftMouseUp:
				...
				[[self textStorage] addAttribute:NSForegroundColorAttributeName value:[NSColor blueColor] range:linkRange];
				done = YES;
				break;
